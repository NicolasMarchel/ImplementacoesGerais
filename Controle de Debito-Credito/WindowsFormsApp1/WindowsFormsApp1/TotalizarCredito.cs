...
{
    class TotalizarCredito : IExecute
    {
            ...
            if(Cad.Count>0)
            {
                ...
                if (caixa.checkMes.Checked)
                {
                    ...
                    caixa.txtTotal.Enabled = true;
                        ...
                        caixa.lblMensagem.Text = "O Crédito total em " + textoMes + " é...";
                 ...
                 if (caixa.checkPeriodo.Checked)
                {
                    ...
                    caixa.txtTotal.Enabled = true;
                        caixa.txtTotal.Text = "R$ " + total.Totalizaçao(Temp).ToString();
                        caixa.lblMensagem.Visible = true;
                        caixa.lblMensagem.Text = "O Crédito total entre " + caixa.dtpInicial.Value.ToString().Substring(0, 10) +
